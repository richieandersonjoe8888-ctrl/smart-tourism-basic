        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('admin.tags.store') }}" method="POST" class="flex gap-3 mb-6 max-w-md">
                    @csrf
                    <input type="text" name="name" placeholder="e.g., historical, adventure, cafe"
                        class="text-sm rounded border-gray-300 w-full" required>
                    <button type="submit"
                        class="bg-green-600 text-white px-4 py-2 rounded text-sm hover:bg-green-700 whitespace-nowrap">Add
                        Tag</button>
                </form>
